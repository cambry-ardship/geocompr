...
cant_buff = st_buffer(canterbury, 100 * 1000)
nz_height_near_cant = nz_height[cant_buff, ]
nrow(nz_height_near_cant) # 95 - 25 more
```
...
world_sfc_mirror = world_sfc * matrix(c(1, -1))
plot(world_sfc)
plot(world_sfc_mirror)

us_states_sfc = st_geometry(us_states)
us_states_sfc_mirror = us_states_sfc * matrix(c(1, -1))
plot(us_states_sfc)
